...
public class ItemSearchService {
    public List<ProductRequestDto> listAllItemDto(String query) throws IOException {
...
// - naverApiResponseJson 에서 우리가 사용할 데이터만 추출 -> List<ItemDto> 객체로 변환
        ...
        List<ProductRequestDto> itemDtoList = objectMapper
                .readerFor(new TypeReference<List<ProductRequestDto>>() {})
                .readValue(itemsNode);
